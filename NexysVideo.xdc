...
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[1]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[1]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[2]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[2]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[3]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[3]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[4]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[4]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[5]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[5]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[6]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[6]]
# set_output_delay -clock [get_clocks sys_clk_pin] -min 0.0   [get_ports led[7]]
# set_output_delay -clock [get_clocks sys_clk_pin] -max 100.0 [get_ports led[7]]
